...
\section{Citations}
Citations are provided by Natbib: \cite{lamport1994latex} or in textual \citet{lamport1994latex} and parenthetical \citep{lamport1994latex} modes. This functionality is separate of the Style file and requires \texttt{\symbol{92}usepackage[numbers]\{natbib\}} in the preamble along with \texttt{\symbol{92}bibliographystyle\{plainnat\}} in the document. 
